 ...
 */
public class ModifyDateTimeFieldWidget extends Panel {
    ...
    public ModifyDateTimeFieldWidget(String id, String labelValue, DataTableGenericResultSetResponse.ColumnHeader columnHeader, Map<String, Object> domainValue) {
        super(id);
    ...
    protected void onInitialize() {
        ...
        DateTextField uiField = DateTextField.forDatePattern("uiField", new PropertyModel<Date>(this.domainValue, this.labelValue), "yyyy-MM-dd HH:mm:ss");
