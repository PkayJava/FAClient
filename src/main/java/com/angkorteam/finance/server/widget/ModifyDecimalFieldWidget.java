 ...
 */
public class ModifyDecimalFieldWidget extends Panel {
    ...
    public ModifyDecimalFieldWidget(String id, String labelValue, DataTableGenericResultSetResponse.ColumnHeader columnHeader, Map<String, Object> domainValue) {
        super(id);
    ...
    protected void onInitialize() {
        ...
        TextField<Double> uiField = new TextField<>("uiField", new PropertyModel<>(this.domainValue, this.labelValue));
        uiField.setType(Double.class);
