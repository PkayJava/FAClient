 ...
 */
public class ModifyStringFieldWidget extends Panel {
    ...
    public ModifyStringFieldWidget(String id, String labelValue, DataTableGenericResultSetResponse.ColumnHeader columnHeader, Map<String, Object> domainValue) {
        super(id);
    ...
    protected void onInitialize() {
        ...
        TextField<String> uiField = new TextField<>("uiField", new PropertyModel<>(this.domainValue, this.labelValue));
