...
public class OfficePreviewTablePreviewExtraPage extends TabbedPage {
    ...
    protected List<BreadcrumbWidget.Breadcrumb> buildBreadcrumb() {
        ...
        menus.add(new BreadcrumbWidget.Breadcrumb(this.office.getName(), null, OfficePreviewTablePreviewExtraPage.class, getPageParameters()));
        return menus;
    }
    ...
    protected List<TabbedWidget.Tabbed> buildTabbed() {
        ...
        tabbed.add(new TabbedWidget.Tabbed(true, "General", null, OfficePreviewTablePreviewExtraPage.class, getPageParameters()));
        tabbed.add(new TabbedWidget.Tabbed(false, "Document", null, OfficePreviewTablePreviewExtraPage.class, getPageParameters()));
        return tabbed;
    }
}
