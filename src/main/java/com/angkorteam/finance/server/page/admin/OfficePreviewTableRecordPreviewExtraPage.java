...
public class OfficePreviewTableRecordPreviewExtraPage extends TabbedPage {
    ...
    protected List<BreadcrumbWidget.Breadcrumb> buildBreadcrumb() {
        ...
        menus.add(new BreadcrumbWidget.Breadcrumb(this.office.getName(), null, OfficePreviewTableRecordPreviewExtraPage.class, getPageParameters()));
        return menus;
    }
    ...
    protected List<TabbedWidget.Tabbed> buildTabbed() {
        ...
        tabbed.add(new TabbedWidget.Tabbed(true, "General", null, OfficePreviewTableRecordPreviewExtraPage.class, getPageParameters()));
        tabbed.add(new TabbedWidget.Tabbed(false, "Document", null, OfficePreviewTableRecordPreviewExtraPage.class, getPageParameters()));
        return tabbed;
    }
}
