 ...
 */
public class RecievePage extends AdminLTEPage {

    private static final Logger LOGGER = LoggerFactory.getLogger(RecievePage.class);
    ...
    protected void onInitialize() {
        ...
        this.cancelButton = new BookmarkablePageLink<>("cancelButton", RecievePage.class, getPageParameters());
    ...
    private void uploadButtonSubmit(Button button) {
        ...
        try {
            ...
            setResponsePage(RecievePage.class, getPageParameters());
            return;
        }
